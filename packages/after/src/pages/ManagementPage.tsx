...
import UserDataTable from '@/components/data-table/user-table';
import PostDataTable from '@/components/data-table/post-table';
...
export const ManagementPage: React.FC = () => {
  ...
  const formatBadgeType = (value: string) => {
    switch (value) {
      case 'development':
        return 'primary';
      case 'design':
        ...
        >
          ...
          <div>
            ...
            <div style={{ border: '1px solid #ddd', background: 'white', overflow: 'auto' }}>
              {entityType === 'user' && (
                <UserDataTable data={data as User[]} onEdit={handleEdit} onDelete={handleDelete} />
              )}
              {entityType === 'post' && (
                <PostDataTable
                  data={data as Post[]}
